...
public class VelocePacketHandler {
    ...
    public static void register(IEventBus modEventBus) {
        modEventBus.addListener(RegisterPayloadHandlersEvent.class, event -> {
            ...
            registrar.playToServer(ControllerPreferKindPKT.TYPE, ControllerPreferKindPKT.STREAM_CODEC, ControllerPreferKindPKT::handle);
            ...
            registrar.playToServer(OpenTabletFromKeyPKT.TYPE, OpenTabletFromKeyPKT.STREAM_CODEC, OpenTabletFromKeyPKT::handle);
