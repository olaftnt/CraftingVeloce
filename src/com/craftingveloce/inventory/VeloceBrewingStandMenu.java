...
public class VeloceBrewingStandMenu extends AbstractContainerMenu {
    ...
    private final VeloceBrewingStandBlockEntity furnace;
    ...
    public VeloceBrewingStandMenu(int id, Inventory playerInv, BlockPos pos, BlockEntity be) {
        this(id, playerInv, pos, be instanceof VeloceBrewingStandBlockEntity f ? f : null);
    }

    public VeloceBrewingStandMenu(int id, Inventory playerInv, BlockPos pos,
                                     VeloceBrewingStandBlockEntity furnace) {
        ...
        this.addSlot(new Slot(
            ...
            public boolean mayPlace(ItemStack stack) {
                return VeloceBrewingStandBlockEntity.isEnergyItem(stack);
            }
    ...
    public VeloceBrewingStandBlockEntity getFurnace() {
        return furnace;
    }
    ...
    public int getMaxEnergy() {
        return furnace == null
                ? VeloceBrewingStandBlockEntity.ENERGY_CAPACITY
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (isBatterySlot) {
            ...
            if (!VeloceBrewingStandBlockEntity.isEnergyItem(inSlot)) {
                return ItemStack.EMPTY;
            }
